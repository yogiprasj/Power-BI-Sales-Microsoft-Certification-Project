...
This project uses the **Adventure Works dataset**, a sample business dataset provided as part of the Microsoft Data Analysis and Visualization with Power BI course on Coursera.
...
This page focuses on customer and product performance analysis.
...
* Total revenue reached **$147.80K** from **48 orders** and **78 products sold**.
* Sales activities were distributed across **18 cities**.
* Revenue trends showed several significant spikes during the observed period, indicating periods of strong customer demand.
...
* Only **50% of orders** were successfully shipped.
* **37.5% of orders** remained in processing status.
* **12.5% of orders** were cancelled.

These results suggest opportunities to improve order fulfillment efficiency and reduce order cancellations.
...
Use demographic and geographic customer data to support more targeted marketing campaigns and improve customer acquisition efforts.
...
https://coursera.org/verify/K7CZ89MUDZ1B

This project serves as practical evidence of the skills acquired throughout the course, including data transformation, data modeling, DAX calculations, dashboard development, and business insight generation.
